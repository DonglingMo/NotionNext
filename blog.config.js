...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || '27cacaa8165843d8aaba140f967cd6de',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Donglingmo', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Ï程序员', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://donglingmo.com', // 网站地址
  ...
  DESCRIPTION: process.env.NEXT_PUBLIC_DESCRIPTION || 'donglingmo的Notion站点', // 站点描述，被notion中的页面描述覆盖
